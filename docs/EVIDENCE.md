...
Snapshot created 10 September 2026. The report is English. The investigation summary records measurements, intermediate results and corrections.
...
| `evidence/investigation-log.md` | `platform/packages/black-flag/diagnostic/identity-audit/RESULTS.md`: chronological measurements, corrections and gameplay results |
...
All visual assets are screenshots or frames captured from the running game. The historical investigation screenshots below are preserved because they show distinct stages of the repair; the latest finished result is kept once in the README.
...
| [Current state of the game](../README.md#current-state-of-the-game) | Latest gameplay screenshot; canonical final-state visual for this repository |
...
The source and compiled dylib match the tested package manifest. Full recordings and GPU captures remain local. Repository packaging does not imply a new test on another machine.
