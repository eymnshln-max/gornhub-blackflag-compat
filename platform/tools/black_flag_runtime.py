...
def environment():
    ...
    metal = ROOT / 'packages/black-flag/experiments/v6-performance/d3dmetal'
    ...
    env.update({
        ...
        'WINEDLLOVERRIDES': 'dxgi,d3d10,d3d10core,d3d11,d3d12=b;nvngx,nvapi64=b;version=n,b;winemenubuilder.exe,mscoree,mshtml=d',
